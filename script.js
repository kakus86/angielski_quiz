    ...
    const pytania_czasowniki_frazowe = ["włączać, odkręcać:", "wyłączać, zakręcać:", "ściszać, przykręcać,odrzucać(np.ofertę):", "podgłaśniać, podkręcać, pojawiać się(ktoś/coś):", "obracać się, odwracać się:", "wprowadzać się (do kogoś):", "iść do przodu, żyć dalej:", "przechodzić do (np.następnego punktu):", "wyprowadzać się:", "przesuwać się:"];
